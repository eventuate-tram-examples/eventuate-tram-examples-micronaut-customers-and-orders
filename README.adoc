...
All services are implemented using [Micronaut](https://micronaut.io), JPA and the https://github.com/eventuate-tram/eventuate-tram-core[Eventuate Tram framework], which provides [transactional publish/subscribe](https://microservices.io/patterns/data/transactional-outbox.html).
